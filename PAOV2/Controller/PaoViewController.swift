...
//        setupBottomControls()
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        print("who is. expersince, good help the world, do won, why everything, save, them self, parrent here what ever, listing to uncle i like to write down, your ability, i'm sure vesuces, most experence, achive, most i like write, second, girl firend free next new year, promotion, singapore airlines rich insurence, pleas say inow, this time, stop achecing wwant in your life , really go, i don't have o mat na, i don't have leack how to dont' right connection, stopping you, really, sign whe external resan nowt many great idan con =fid sell everything, ggre==rer banlanc")
